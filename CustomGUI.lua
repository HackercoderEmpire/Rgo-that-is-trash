...
local Utility = {}
local Objects = {}
function    ShadowReconGUI:DraggingEnabled(frame, parent)
...
local themeStyles = {
    ...
    Ocean = {
        SchemeColor = Color3.fromRGB(0, 140, 255),
        Background = Color3.fromRGB(26, 32, 44),
        Header = Color3.fromRGB(19, 24, 32),
        TextColor = Color3.fromRGB(255, 255, 255),
        ElementColor = Color3.fromRGB(19, 24, 32)
    },

    Violet = {
        SchemeColor = Color3.fromRGB(139, 0, 255),
        Background = Color3.fromRGB(33, 33, 43),
    ...
    NeonGreen = {
        SchemeColor = Color3.fromRGB(57, 255, 20),
        Background = Color3.fromRGB(28, 34, 33),
        Header = Color3.fromRGB(18, 22, 22),
        TextColor = Color3.fromRGB(255, 255, 255),
        ElementColor = Color3.fromRGB(18, 22, 22)
    },
    ...
    Aqua = {
        ...
        Background = Color3.fromRGB(40, 45, 50),
        Header = Color3.fromRGB(30, 35, 40),
        TextColor = Color3.fromRGB(255, 255, 255),
        ElementColor = Color3.fromRGB(30, 35, 40)
    },

    Sunset = {
        SchemeColor = Color3.fromRGB(255, 94, 77),
        Background = Color3.fromRGB(46, 44, 55),
        Header = Color3.fromRGB(34, 32, 42),
        TextColor = Color3.fromRGB(255, 255, 255),
        ElementColor = Color3.fromRGB(34, 32, 42)
    },

    Forest = {
        SchemeColor = Color3.fromRGB(34, 139, 34),
        Background = Color3.fromRGB(23, 32, 25),
        Header = Color3.fromRGB(19, 26, 19),
        TextColor = Color3.fromRGB(255, 255, 255),
        ElementColor = Color3.fromRGB(19, 26, 19)
    },
    ...
    Lava = {
        ...
        TextColor = Color3.fromRGB(255, 255, 255),
        ElementColor = Color3.fromRGB(30, 20, 20)
    },
    Pink = {
        SchemeColor = Color3.fromRGB(255, 105, 180), -- Hot Pink
        Background = Color3.fromRGB(45, 45, 60),    -- Dark background
        Header = Color3.fromRGB(35, 35, 50),         -- Slightly darker header
        TextColor = Color3.fromRGB(255, 255, 255),   -- White text for contrast
        ElementColor = Color3.fromRGB(50, 50, 70)    -- Slightly darker elements
    }
...
local Name = "ShadowReconGUIConfig.JSON"

pcall(function()

if not pcall(function() readfile(Name) end) then
writefile(Name, game:service'HttpService':ShadowReconGUIcode(SettingsT))
end

---@diagnostic disable-next-line: deprecated
Settings = game:service'HttpService':ShadowReconGUIcode(readfile(Name))
end)

local LibName = tostring(math.random(1, 100))..tostring(math.random(1,50))..tostring(math.random(1, 100))

function ShadowReconGUI:ToggleUI()
...
function ShadowRecon.CreateLib(ShaName, themeList)
...
elseif themeList == "PinkTheme" then  -- Check for PinkTheme
    themeList = themeStyles.PinkTheme
else
...
local selectedTab 
ShaName = ShaName or "Library"
table.insert(ShadowReconGUI, ShaName)

for i, v in pairs(game.CoreGui:GetChildren()) do
    if v:IsA("ScreenGui") and v.Name == ShaName then
        v:Destroy()
    end
end
    ...
    ShadowReconGUI:DraggingEnabled(MainHeader, Main)
    ...
    function ShadowReconGUI:ChangeColor(prope,color)
