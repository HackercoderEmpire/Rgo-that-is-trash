...
local Themes = {
	...
	Neon = {
		...
		Header = Color3.fromRGB(40, 40, 60),
		TextColor = Color3.fromRGB(255, 255, 255),
		ElementColor = Color3.fromRGB(57, 255, 20)
	},
	Sunset = {
		SchemeColor = Color3.fromRGB(255, 94, 77),
		Background = Color3.fromRGB(255, 195, 113),
		Header = Color3.fromRGB(255, 144, 104),
		TextColor = Color3.fromRGB(94, 77, 255),
		ElementColor = Color3.fromRGB(255, 144, 104)
	},
	Ocean = {
		SchemeColor = Color3.fromRGB(0, 119, 182),
		Background = Color3.fromRGB(0, 180, 216),
		Header = Color3.fromRGB(72, 202, 228),
		TextColor = Color3.fromRGB(144, 224, 239),
		ElementColor = Color3.fromRGB(0, 119, 182)
	},
	Forest = {
		SchemeColor = Color3.fromRGB(34, 139, 34),
		Background = Color3.fromRGB(107, 142, 35),
		Header = Color3.fromRGB(85, 107, 47),
		TextColor = Color3.fromRGB(255, 255, 255),
		ElementColor = Color3.fromRGB(34, 139, 34)
	},
	Pastel = {
		SchemeColor = Color3.fromRGB(255, 182, 193),
		Background = Color3.fromRGB(176, 224, 230),
		Header = Color3.fromRGB(221, 160, 221),
		TextColor = Color3.fromRGB(119, 136, 153),
