...
-- Use CoreGui for more consistent results in executor environments
...
ScriptHub.Size = UDim2.new(0.25, -10, 1, -110) -- Adjusted to not overlap title or buttons
ScriptHub.Position = UDim2.new(0.75, 0, 0, 45) -- Push below title bar
